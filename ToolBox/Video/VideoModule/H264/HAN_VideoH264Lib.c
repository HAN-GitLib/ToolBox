...
static inline BOOL H264UintToBool(uint8_t nBool);
...
static inline VIDEOMP4READUERET H264ReadSE(PVIDEOMP4READUE pReadUE)
{
    ...
    {
        if ((1 & pReadUE->cValue.u32) == 0) { pReadUE->cValue.s32 = -1; }
        else { pReadUE->cValue.s32 = 1; }
        pReadUE->cValue.s32 *= (pReadUE->cValue.u32 + 1) >> 1;
    }
